...
from .serializers import PurchaseHeaderBaseSerializer, PurchaseHeaderUpdateSerializer, PurchaseDetailBaseSerializer
...
class PurchaseHeaderGetEditDeleteView(APIView):
    ...
    def get(self, request, code):
        ...
        # Purchase Header Tidak Ada
            ...
            return Response(status=status.HTTP_404_NOT_FOUND, data={"message": PURCHASE_NOT_FOUND_MESSAGE})
    ...
    def put(self, request, code):
        try:
            ...
            serializer = PurchaseHeaderUpdateSerializer(purchase_header, data=request.data)
...
class PurchaseDetailView(APIView):
    ...
    def get(self, request, header_code):
        try:
            ...
            purchase_detail = PurchaseDetail.objects.filter(code=header_code, is_deleted=False)
